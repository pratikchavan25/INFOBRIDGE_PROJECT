...
namespace InfoBridge_Assignment.App_Code
{
    public class EmployeeDAL
    {
        ...
        {
            Employee emp = new Employee();
            string qry = "select * from EmpDetails where Id=@Id";
            cmd = new SqlCommand(qry, con);
        ...
        {
            string qry = "insert into EmpDetails values(@Id,@Name,@DateOfBirth,@Sex,@Phone,@Address,@Image)";
            cmd = new SqlCommand(qry, con);
        ...
        {
            string qry = "update EmpDetails set Name=@Name,DateOfBirth=@DateOfBirth,Sex=@Sex,Phone=@Phone,Address=@Address,Image=@Image where Id=@Id";
            cmd = new SqlCommand(qry, con);
            cmd.Parameters.AddWithValue("@Name", emp.Name);
            cmd.Parameters.AddWithValue("@DateOfBirth", emp.DateOfBirth);
            cmd.Parameters.AddWithValue("@Sex", emp.Sex);
        ...
        {
            string qry = "delete from EmpDetails where id=@Id";
            cmd=new SqlCommand(qry, con);
            cmd.Parameters.AddWithValue("@Id", id);
            con.Open();
            int result = cmd.ExecuteNonQuery();
